...
class DepartmentsFragment : Fragment() {
    ...
    private var departmentsAdapter = DepartmentsAdapter(DepartmentComparator) {
        val action = com.solvro.topwr.features.departments.presentation.list.DepartmentsFragmentDirections.actionDepartmentsFragmentToDepartmentsDetailsFragment(
